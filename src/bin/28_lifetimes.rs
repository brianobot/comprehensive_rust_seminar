...
fn main() {
    ...
    let hight_1 = Highlight{ slice: point_1, color: HighlightColor::GREEN };
    let hight_2 = Highlight{ slice: point_2, color: HighlightColor::GREY }; // this works because at this point the point_1 and point_2 references are still alive
